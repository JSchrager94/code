...
data long2 (keep= subject BL_A1c  BL_wt DM_duration Number_DM_meds
	study_id group condition age gender race DM_Duration Number_DM_Meds
	...
	array Cpep_Ins (*) BL_Ratio_Cpep_Ins_AUC V2_Ratio_Cpep_Ins_AUC V3_Ratio_Cpep_Ins_AUC;
		...
		do i=1 to dim(wt);
            ...
            Glu_AUC_120_180=GluAUC120_180(i);ISI=ISIn (i);Ins_AUC_0_120=InsAUC120(i); MISI_0_120=MISI(i);
             ...
             Visit=I; 
			output long2;*the output command prints every i in the do loop instead of just the last output;
		end;
...
proc mixed data=vetter.mergedadd   ORDER = FORMATTED; *WHERE WEIGHT_IN_WIND_EIGHTWKWIND = 1; 
    &wher;
